...
function dockerArchive(targetImage) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const archivePath = image_type_1.getDockerArchivePath(targetImage);
        if (!fs.existsSync(archivePath)) {
            throw new Error("The provided docker archive path does not exist on the filesystem");
        }
        ...
        return yield getStaticAnalysisResult(imageIdentifier, archivePath);
    });
}
...
function distroless(targetImage, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
            return yield getStaticAnalysisResult(targetImage, archiveFullPath);
        }
        finally {
...
function getStaticAnalysisResult(targetImage, archivePath) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        return yield staticModule.analyzeStatically(targetImage, scanningOptions);
    });
}
