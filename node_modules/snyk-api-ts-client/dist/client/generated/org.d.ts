...
export declare namespace Members {
    ...
    export namespace Update {
        class Update {
            private currentContext;
            private userId;
            constructor(parentContext: Object, Updateparam: updateClass, fullResponse?: boolean);
...
export declare namespace Integrations {
    ...
    interface ImportPostBodyType1 {
        ...
        files?: string[];
        /**
         * a comma-separated list of up to 10 folder names to exclude from scanning (each folder name must not exceed 100 characters). If not specified, it will default to "fixtures, tests, \_\_tests\_\_, node_modules". If an empty string is provided - no folders will be excluded
         */
...
export declare namespace Project {
    ...
    export namespace Issue {
        ...
        namespace Paths {
            class Paths {
                private currentContext;
                constructor(parentContext: Object, fullResponse?: boolean);
                get(snapshotId?: string, perPage?: number, page?: number): Promise<PathsGetResponseType>;
                getAll(snapshotId?: string, noLimitMode?: boolean): Promise<PathsGetResponseType[]>;
            }
        }
    ...
    export interface HistoryPostResponseType {
        /**
         * A list of the project's snapshots
         */
        snapshots?: {
            /**
    ...
    export namespace History {
        export class History {
            ...
            private snapshotId;
            aggregatedissues: Aggregatedissues.Aggregatedissues;
            constructor(parentContext: Object, Historyparam: historyClass, fullResponse?: boolean);
            issue(Issueparam?: issueClass): Issue.Issue;
            post(body: HistoryPostBodyType, perPage?: number, page?: number): Promise<HistoryPostResponseType>;
            postAll(body: HistoryPostBodyType, noLimitMode?: boolean): Promise<HistoryPostResponseType[]>;
        }
        export interface AggregatedissuesPostBodyType {
            /**
             * If set to `true`, Include issue's description, if set to `false` (by default), it won't (Non-IaC projects only)
...
export declare namespace Dependencies {
    class Dependencies {
        ...
        postAll(body: DependenciesPostBodyType, sortBy?: string, order?: string, noLimitMode?: boolean): Promise<DependenciesPostResponseType[]>;
    }
}
